...
public class RestauranteController {
	...
	private PedidoRepository pedidoRepository;
		...
		public String relatorioPedidos(
				@ModelAttribute("relatoriosPedidoFilter") RelatorioPedidoFilter filter,
				Model model) {
			Integer restauranteId = SecurityUtils.loggedRestaurante().getId();
		...
		public String relatorioItens(
			...
			List<RelatorioItemFaturamento> itensCalculado = relatorioService.calcularFaturamentoItens(restauranteId, filter);
			model.addAttribute("itensCalculados", itensCalculado);
